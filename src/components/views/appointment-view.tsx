    ...
    return (
      <section className="bg-mist py-16 sm:py-24">
        <div className="container-x max-w-2xl">
          ...
          >
            <div className="bg-gradient-to-br from-brand-900 to-jade-700 px-8 py-12 text-center">
              <motion.span
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
              ...
              <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-jade-100/85">
            ...
            <div className="p-8 sm:p-10">
              ...
              <p className="mt-5 rounded-2xl border border-jade-200 bg-jade-50 p-4 text-xs font-semibold leading-relaxed text-jade-700">
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                <button
                  ...
                  className="flex-1 rounded-full bg-brand-900 px-6 py-3.5 text-sm font-bold text-white transition hover:bg-brand-800"
                >
                  Back to Home
                </button>
                <button
                  onClick={reset}
                  className="flex-1 rounded-full border border-jade-200 bg-jade-50 px-6 py-3.5 text-sm font-bold text-jade-700 transition hover:bg-jade-100"
                >
                  Book Another
                </button>
              </div>
    ...
    <section className="bg-mist py-12 sm:py-16">
      <div className="container-x">
        <Reveal className="mx-auto max-w-2xl text-center">
          <span className="inline-flex items-center gap-2 rounded-full border border-jade-200 bg-jade-50 px-4 py-1.5 text-xs font-bold uppercase tracking-[0.14em] text-jade-700">
          ...
          <Reveal>
            <aside className="rounded-3xl border border-border/70 bg-white p-7 shadow-soft lg:sticky lg:top-24">
                    ...
                    <li key={label} className="flex shrink-0 items-center gap-3 lg:w-full">
                      <span
                        className={`grid h-9 w-9 shrink-0 place-items-center rounded-full text-xs font-extrabold transition-all ${
                            ...
                            : active
                              ? "bg-brand-900 text-white ring-4 ring-jade-100"
                      ...
                      <span
                        className={`whitespace-nowrap text-sm font-bold lg:whitespace-normal ${
                          active ? "text-brand-900" : done ? "text-jade-700" : "text-ink-400"
                        }`}
                      >
                        {label}
                      </span>
              ...
              <div className="mt-7 hidden rounded-2xl bg-mist p-5 lg:block">
                ...
                <ul className="mt-3 space-y-2 text-sm font-semibold text-brand-800">
            ...
            <div className="rounded-3xl border border-border/70 bg-white p-7 shadow-soft sm:p-9">
              <AnimatePresence mode="wait">
                ...
                >
                        ...
                        {DEPARTMENTS.map((dep) => (
                          <button
                            ...
                            className={`group flex items-center gap-3 rounded-2xl border p-4 text-left transition-all ${
                              department === dep.id
                                ? "border-jade-600 bg-jade-50 ring-2 ring-jade-200"
                                : "border-border bg-white hover:border-jade-300 hover:bg-jade-50/40"
                            }`}
                          >
                            <span className={`grid h-10 w-10 shrink-0 place-items-center rounded-xl transition ${
                              department === dep.id ? "bg-jade-600 text-white" : "bg-mist text-jade-600"
                            }`}>
                              <dep.icon className="h-5 w-5" />
                            </span>
                            <span className="text-sm font-extrabold text-brand-900">{dep.name}</span>
                          </button>
                        ))}
                      </div>
                    </div>
                  ...
                  {step === 1 && (
                    <div>
                      ...
                      <div className="mt-6 grid gap-3 sm:grid-cols-2">
                        ...
                        >
                          <span className="grid h-12 w-12 shrink-0 place-items-center rounded-full bg-gradient-to-br from-jade-400 to-brand-800 text-sm font-extrabold text-white">
                            Any
                          </span>
                          <span>
                            <span className="block text-sm font-extrabold text-brand-900">No Preference</span>
                        ...
                        {doctors.map((doc) => (
                          ...
                          >
                            ...
                            />
                            <span>
                              <span className="block text-sm font-extrabold text-brand-900">{doc.name}</span>
                              <span className="block text-xs font-semibold text-jade-700">{doc.specialization}</span>
                            </span>
                          </button>
                        ))}
                        {doctors.length === 0 && (
                  ...
                  {step === 2 && (
                    <div>
                      <div className="flex items-center justify-between">
                        <div>
                          <h2 className="text-xl font-extrabold tracking-tight text-brand-900">Select Date</h2>
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="grid h-10 w-10 place-items-center rounded-full border border-border transition enabled:hover:bg-jade-50 disabled:opacity-30"
                      ...
                      <p className="mt-6 text-center text-base font-extrabold uppercase tracking-[0.14em] text-brand-900">
                            ...
                            <button
                              ...
                              className={`aspect-square rounded-xl text-sm font-bold transition-all ${
                                !cell.inMonth
                                  ? "opacity-0"
                                  : selected
                                    ? "scale-105 bg-jade-600 text-white shadow-soft"
                                    : cell.disabled
                                      ? "text-jade-300"
                                      : "text-brand-800 hover:bg-jade-50 hover:ring-2 hover:ring-jade-100"
                  ...
                  {step === 3 && (
                    <div>
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h2 className="text-xl font-extrabold tracking-tight text-brand-900">Select Time</h2>
                          <p className="mt-0.5 text-sm font-semibold text-jade-700">
                          ...
                          return (
                            <button
                              ...
                              className={`rounded-xl px-2 py-3 text-sm font-bold transition-all ${
                                booked
                                  ? "cursor-not-allowed bg-mist text-jade-300 line-through"
                                  : time === slot
                                    ? "bg-jade-600 text-white shadow-soft"
                                    : "bg-mist text-brand-800 hover:bg-jade-50 hover:ring-2 hover:ring-jade-100"
                              }`}
                            >
                              {slot}
                            </button>
                  ...
                  {step === 4 && (
                    <div>
                      <h2 className="text-xl font-extrabold tracking-tight text-brand-900">Patient Details</h2>
                      <p className="mt-1.5 text-sm text-ink-500">
                        We will call to confirm your appointment.
                      </p>
                      <div className="mt-6 grid gap-4 sm:grid-cols-2">
                        <label className="block">
                          <span className="mb-1.5 flex items-center gap-1.5 text-xs font-extrabold uppercase tracking-[0.12em] text-brand-900">
                            <User className="h-3.5 w-3.5 text-jade-600" /> Full Name *
                          </span>
                          <input
                            value={name}
                            onChange={(e) => setName(e.target.value)}
                            placeholder="e.g. Priya Nair"
                            className="w-full rounded-2xl border border-border bg-mist/60 px-4.5 py-3.5 text-sm font-semibold outline-none transition focus:border-jade-400 focus:bg-white focus:ring-2 focus:ring-jade-100"
                          />
                        </label>
                        <label className="block">
                          <span className="mb-1.5 flex items-center gap-1.5 text-xs font-extrabold uppercase tracking-[0.12em] text-brand-900">
                            <Phone className="h-3.5 w-3.5 text-jade-600" /> Phone Number *
                          </span>
                          <input
                            value={phone}
                        ...
                        <label className="block sm:col-span-2">
                          <span className="mb-1.5 flex items-center gap-1.5 text-xs font-extrabold uppercase tracking-[0.12em] text-brand-900">
                            <Mail className="h-3.5 w-3.5 text-jade-600" /> Email (optional)
                          </span>
                          <input
                            value={email}
                        ...
                        <label className="block sm:col-span-2">
                          <span className="mb-1.5 block text-xs font-extrabold uppercase tracking-[0.12em] text-brand-900">
                            Notes (optional)
                          </span>
                          <textarea
                            value={notes}
                            ...
                            rows={3}
                            className="w-full resize-none rounded-2xl border border-border bg-mist/60 px-4.5 py-3.5 text-sm font-semibold outline-none transition focus:border-jade-400 focus:bg-white focus:ring-2 focus:ring-jade-100"
                          />
                        </label>
                      </div>
              ...
              <div className="mt-9 flex items-center justify-between gap-4 border-t border-border pt-6">
                <button
                  ...
                  disabled={step === 0}
                  className="inline-flex items-center gap-2 rounded-full border border-border px-6 py-3.5 text-sm font-bold text-brand-900 transition enabled:hover:bg-jade-50 disabled:invisible"
                >
                ...
                {step < 4 ? (
                  ...
                  <button
                    ...
                    className={`inline-flex items-center gap-2 rounded-full px-8 py-3.5 text-sm font-extrabold transition-all ${
                      canContinue
                        ? "bg-brand-900 text-white shadow-soft hover:bg-brand-800"
                        : "cursor-not-allowed bg-mist text-ink-400"
                    }`}
                  >
